...
// __RECIPE_START__
export const RECIPE = {
  key: null,        // [r,g,b] to remove; null = sample the image corners
  low: 10,          // distance below which a pixel is fully clear
  high: 70,         // distance above which it is fully opaque
  feather: 2,       // px of blur on the alpha edge
  fade: 100,        // gamma on the ramp: <100 hardens, >100 softens
  despill: true,    // strip the key hue from partially-transparent edges
  holesOnly: false, // light only enclosed openings, not the space around the subject
  mode: "cycle",    // cycle | spectrum | radial | plasma
  speed: 40,        // hue rotation, deg/sec
  react: 100,       // how hard the audio modulates, %
  sat: 85,          // saturation, %
  bright: 60,       // base brightness, %
  spread: 120,      // hue spread across the field, deg
};
// __RECIPE_END__
